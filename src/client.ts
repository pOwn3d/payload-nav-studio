...
export { NavUserProfile } from './components/NavUserProfile.js'
export { default as NavFooterSlot } from './components/NavFooterSlot.js'
export { useNavPreferences, cacheOwnerKey } from './hooks/useNavPreferences.js'
export { usePluginTranslation } from './hooks/usePluginTranslation.js'
export { resolveLabel, isMultiLang, isSafeHref } from './utils.js'
